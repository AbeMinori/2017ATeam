...
/* 腕回転部のduty */
#define _ARM_DUTY (5000/*DD_MD_MAX_DUTY-1*/)
#define MD_AHEAD_ROTATE_DUTY -_ARM_DUTY
#define MD_BACKWARD_ROTATE_DUTY _ARM_DUTY
...
/* 腕前方向回転用のリミットスイッチ */
#define _SW_AHEAD_LIMIT_GPIOxPIN GPIOBID
#define _SW_AHEAD_LIMIT_GPIOPIN GPIO_PIN_15
#define _IS_PRESSED_AHEAD_LIMITSW() (!(MW_GPIORead(_SW_AHEAD_LIMIT_GPIOxPIN,_SW_AHEAD_LIMIT_GPIOPIN)))
